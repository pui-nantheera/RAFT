...
python train_self.py --name raft-ESPRIT --stage ESPRIT --validation ESPRIT --gpus 0 --num_steps 100 --batch_size 1 --lr 0.0004 --image_size 368 768 --restore_ckpt "models/raft-things.pth" --save_ckpt 'D:/Pui/results/RAFT'
